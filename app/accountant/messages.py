...
BALANCE_CREATED = 'Успешно создан'
...
BALANCE_SET_ENTER_AMOUNT_PLACEHOLDER = '123.45'
BALANCE_SET_ENTER_AMOUNT_ERROR = (
    '{mention}Неверный формат суммы `{entered_amount}`\n\n'
    'Введи корректное значение'
)
BALANCE_SET_SAVED = 'Значение сохранено'

BALANCE_DELETE_CHOOSE_ONE = 'Выбери баланс для удаления'
BALANCE_DELETE_APPROVE = 'Точно хочешь удалить его?'
BALANCE_DELETED = 'Успешно удален'
