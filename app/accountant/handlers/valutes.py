...
class RateListHandler(CommandHandler):
    ...
    async def handle(self) -> None:
        ...
        rate_list = []
        code_width = 0
        per_dollar_avg_width = 0
        per_dollar_cur_width = 0
        dollar_per_valute_avg_width = 0
        dollar_per_valute_cur_width = 0
